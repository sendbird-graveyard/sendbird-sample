//
//  BroadcastMessageTableViewCell.swift
//  SendBirdSwiftSample
//
...
class BroadcastMessageTableViewCell: UITableViewCell {
    ...
    func initViews() {
        ...
        // Inner View
        self.addConstraint(NSLayoutConstraint.init(item: self.innerView!, attribute: NSLayoutAttribute.Top, relatedBy: NSLayoutRelation.Equal, toItem: contentView, attribute: NSLayoutAttribute.Top, multiplier: 1, constant: kBroadcastMessageCellTopMargin))
        self.addConstraint(NSLayoutConstraint.init(item: self.innerView!, attribute: NSLayoutAttribute.Leading, relatedBy: NSLayoutRelation.Equal, toItem: contentView, attribute: NSLayoutAttribute.Leading, multiplier: 1, constant: kBroadcastMessageCellLeftMargin))
        self.addConstraint(NSLayoutConstraint.init(item: self.innerView!, attribute: NSLayoutAttribute.Trailing, relatedBy: NSLayoutRelation.Equal, toItem: contentView, attribute: NSLayoutAttribute.Trailing, multiplier: 1, constant: kBroadcastMessageCellRightMargin))
        self.addConstraint(NSLayoutConstraint.init(item: self.innerView!, attribute: NSLayoutAttribute.Bottom, relatedBy: NSLayoutRelation.Equal, toItem: contentView, attribute: NSLayoutAttribute.Bottom, multiplier: 1, constant: -kBroadcastMessageCellBottomMargin))
        
        // Message Label
        self.addConstraint(NSLayoutConstraint.init(item: self.messageLabel!, attribute: NSLayoutAttribute.Top, relatedBy: NSLayoutRelation.Equal, toItem: self.innerView, attribute: NSLayoutAttribute.Top, multiplier: 1, constant: kBroadcastMessageCellTopPadding))
        self.addConstraint(NSLayoutConstraint.init(item: self.messageLabel!, attribute: NSLayoutAttribute.Leading, relatedBy: NSLayoutRelation.Equal, toItem: self.innerView, attribute: NSLayoutAttribute.Leading, multiplier: 1, constant: kBroadcastMessageCellLeftPadding))
        self.addConstraint(NSLayoutConstraint.init(item: self.messageLabel!, attribute: NSLayoutAttribute.Trailing, relatedBy: NSLayoutRelation.Equal, toItem: self.innerView, attribute: NSLayoutAttribute.Trailing, multiplier: 1, constant: -kBroadcastMessageCellRightPadding))
        self.addConstraint(NSLayoutConstraint.init(item: self.messageLabel!, attribute: NSLayoutAttribute.Bottom, relatedBy: NSLayoutRelation.Equal, toItem: self.innerView!, attribute: NSLayoutAttribute.Bottom, multiplier: 1, constant: -kBroadcastMessageCellBottomPadding))
    }
    ...
    func getHeightOfViewCell(totalWidth: CGFloat) -> CGFloat {
        ...
        let attributedMessage = self.buildMessage()
